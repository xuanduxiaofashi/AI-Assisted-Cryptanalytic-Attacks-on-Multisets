...
int main()
{
    ...
    for (int i = 0 ; i < repeat_num; i ++)
    {
        ...
        for( int k = 0; k < 16; k ++)
        {
            ...
            int temp_1 = ciphertext_no_xor[k][6] ^ ciphertext_no_xor[k][10]  ^ ciphertext_no_xor[k][14] ;
            int temp_2 = ciphertext_no_xor[k][0] ^ ciphertext_no_xor[k][12] ;
            int temp_3 = ciphertext_no_xor[k][7] ^ ciphertext_no_xor[k][15] ;
            int write_num = 
                static_cast<int>(std::bitset<4>(temp_1)[3]) ^ 

                static_cast<int>(std::bitset<4>(temp_2)[0]) ^ static_cast<int>(std::bitset<4>(temp_2)[1]) ^ static_cast<int>(std::bitset<4>(temp_2)[2]) ^ 
                (static_cast<int>(std::bitset<4>(temp_2)[0])&static_cast<int>(std::bitset<4>(temp_2)[1]))  ^  (static_cast<int>(std::bitset<4>(temp_2)[0])&static_cast<int>(std::bitset<4>(temp_2)[2]))  ^  (static_cast<int>(std::bitset<4>(temp_2)[1])&static_cast<int>(std::bitset<4>(temp_2)[3])) ^ 
                (static_cast<int>(std::bitset<4>(temp_2)[0])& static_cast<int>(std::bitset<4>(temp_2)[2])&static_cast<int>(std::bitset<4>(temp_2)[3])) ^ ( static_cast<int>(std::bitset<4>(temp_2)[3])& static_cast<int>(std::bitset<4>(temp_2)[2])&static_cast<int>(std::bitset<4>(temp_2)[1])) ^

                static_cast<int>(std::bitset<4>(temp_3)[0]) ^ static_cast<int>(std::bitset<4>(temp_3)[1]) ^ static_cast<int>(std::bitset<4>(temp_3)[2]) ^ 
                static_cast<int>(std::bitset<4>(temp_3)[0])&static_cast<int>(std::bitset<4>(temp_3)[1]) ^ static_cast<int>(std::bitset<4>(temp_3)[0])&static_cast<int>(std::bitset<4>(temp_3)[2]) ^  static_cast<int>(std::bitset<4>(temp_3)[1])&static_cast<int>(std::bitset<4>(temp_3)[3]) ^ 
                static_cast<int>(std::bitset<4>(temp_3)[0])& static_cast<int>(std::bitset<4>(temp_3)[2])&static_cast<int>(std::bitset<4>(temp_3)[3]) ^  static_cast<int>(std::bitset<4>(temp_3)[3])& static_cast<int>(std::bitset<4>(temp_3)[2])&static_cast<int>(std::bitset<4>(temp_3)[1]) 
                ;
