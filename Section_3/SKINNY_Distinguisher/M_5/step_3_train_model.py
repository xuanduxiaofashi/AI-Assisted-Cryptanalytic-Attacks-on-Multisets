...
def gen_train_or_val_data(train_num,  load_file_name):
    ...
    train_X_label_0 = np.random.choice([0, 1], size=(train_num_label_1 * 54 , 16 , 12))
    ...
    temp_1_3 = temp_1_label_0[:, :, 0]
    temp_1_2 = temp_1_label_0[:, :, 1]
    temp_1_1 = temp_1_label_0[:, :, 2]
    temp_1_0 = temp_1_label_0[:, :, 3]


    temp_2_3 = temp_2_label_0[:, :, 0]
    temp_2_2 = temp_2_label_0[:, :, 1]
    temp_2_1 = temp_2_label_0[:, :, 2]
    temp_2_0 = temp_2_label_0[:, :, 3]


    temp_3_3 = temp_3_label_0[:, :, 0]
    temp_3_2 = temp_3_label_0[:, :, 1]
    temp_3_1 = temp_3_label_0[:, :, 2]
    temp_3_0 = temp_3_label_0[:, :, 3]


    cp_x_9_3 = temp_3_2 ^ temp_3_3 ^ (temp_3_1 & temp_3_0) ^ (temp_3_3 & temp_3_0) ^ (temp_3_3 & temp_3_1) ^ (temp_3_2 & temp_3_1) ^ (temp_3_3 & temp_3_2 & temp_3_1)
    cp_x_9_2 = temp_3_0 ^ temp_3_1 ^ temp_3_2 ^ (temp_3_3 & temp_3_0) ^ (temp_3_3 & temp_3_2)
    cp_x_9_1 = temp_3_0 ^ (temp_3_3 & temp_3_2) ^ temp_3_3 ^ temp_3_2
    cp_x_9_0 = temp_3_0 ^ temp_3_1 ^ temp_3_2 ^ (temp_3_1 & temp_3_0) ^ (temp_3_2 & temp_3_0) ^ (temp_3_3 & temp_3_1) ^ (temp_3_3 & temp_3_2 & temp_3_0) ^ (temp_3_3 & temp_3_2 & temp_3_1)

    cp_x_13_3 = temp_2_2 ^ temp_2_3 ^ (temp_2_1 & temp_2_0) ^ (temp_2_3 & temp_2_0) ^ (temp_2_3 & temp_2_1) ^ (temp_2_2 & temp_2_1) ^ (temp_2_3 & temp_2_2 & temp_2_1)
    cp_x_13_2 = temp_2_0 ^ temp_2_1 ^ temp_2_2 ^ (temp_2_3 & temp_2_0) ^ (temp_2_3 & temp_2_2)
    cp_x_13_1 = temp_2_0 ^ (temp_2_3 & temp_2_2) ^ temp_2_3 ^ temp_2_2
    cp_x_13_0 = temp_2_0 ^ temp_2_1 ^ temp_2_2 ^ (temp_2_1 & temp_2_0) ^ (temp_2_2 & temp_2_0) ^ (temp_2_3 & temp_2_1) ^ (temp_2_3 & temp_2_2 & temp_2_0) ^ (temp_2_3 & temp_2_2 & temp_2_1) 

    train_X_column_1 = temp_1_3 ^ cp_x_9_0 ^ cp_x_13_0 
    train_X_column_2 = temp_1_3 ^ cp_x_9_0 ^ cp_x_13_0 ^ cp_x_9_2 ^ cp_x_13_2
    train_X_column_3 = temp_1_3 ^ cp_x_9_0 ^ cp_x_13_0 ^ cp_x_9_3 ^ cp_x_13_3  
    train_X_column_4 =  temp_1_3 ^ cp_x_9_0 ^ cp_x_13_0 ^ cp_x_9_2 ^ cp_x_13_2 ^ cp_x_9_3 ^ cp_x_13_3 

    train_X_column_5 = temp_1_2 ^ cp_x_9_3 ^ cp_x_13_3
    train_X_column_6 = temp_1_2 ^ cp_x_9_3 ^ cp_x_13_3 ^ cp_x_9_2 ^ cp_x_13_2
    train_X_column_7 = temp_1_2 ^ cp_x_9_3 ^ cp_x_13_3 ^ cp_x_9_1 ^ cp_x_13_1  
    train_X_column_8 =  temp_1_2 ^ cp_x_9_3 ^ cp_x_13_3 ^ cp_x_9_2 ^ cp_x_13_2 ^ cp_x_9_1 ^ cp_x_13_1 

    train_X_label_0 = np.concatenate([train_X_column_1,  train_X_column_2,
                               train_X_column_3, train_X_column_4,train_X_column_5, train_X_column_6,
                               train_X_column_7, train_X_column_8  ], axis=1)
    

    train_X_label_0 = train_X_label_0.reshape( train_num_label_1 , -1)
