...
void enc_package(int R,  uint8_t ciphertext_xor[16][16], int choose_block)
{
    ...
    tweakey_1_random = 0x0123456789abcdef;
...
int main(int argc, char* argv[])
{
    ...
    uint8_t ciphertext_no_xor_process[16][16]; 
    int guess_key_2;
    int guess_key_7;
    
    guess_key_2 = atoi(argv[1]);  
    guess_key_7 = atoi(argv[2]);  

    double repeat_num = pow(2, train_num) * 4 ;
    ...
    fileName << "cipher_txt_npy_8r/" <<  "cipher" << "_8r_" << "2_" << train_num << "_key_" << guess_key_2 << "_" <<  guess_key_7 << ".txt"; 
    ...
    for (int i = 0 ; i < repeat_num; i ++)
    {
        ...
        int xor_num = 0;
        int sbox_inv[16] = {3, 4,  6, 8, 12, 10, 1, 14, 9, 2, 5, 7, 0, 11, 13, 15};
        


        for(int p_k = 0; p_k < 16; p_k ++)
        {
            ciphertext_no_xor_process[p_k][2] = sbox_inv[ciphertext_no_xor[p_k][6] ^ guess_key_2];
            ciphertext_no_xor_process[p_k][7] = sbox_inv[ciphertext_no_xor[p_k][4] ^ ciphertext_no_xor[p_k][8] ^ ciphertext_no_xor[p_k][12] ^ guess_key_7];
            ciphertext_no_xor_process[p_k][14] = sbox_inv[ciphertext_no_xor[p_k][1] ^ ciphertext_no_xor[p_k][13]];
        ...
        for( int k = 0; k < 16; k ++) 
        {
            ...
            outfile <<  (static_cast<int>(std::bitset<4>(ciphertext_no_xor_process[k][2])[3] )  ^ static_cast<int>(std::bitset<4>(ciphertext_no_xor_process[k][7])[3] ) ^ static_cast<int>(std::bitset<4>(ciphertext_no_xor_process[k][14])[3] )) << " ";
        ...
        for( int k = 0; k < 16; k ++)
        {
            ...
            outfile <<  (static_cast<int>(std::bitset<4>(ciphertext_no_xor_process[k][2])[2] )  ^ static_cast<int>(std::bitset<4>(ciphertext_no_xor_process[k][7])[2] ) ^ static_cast<int>(std::bitset<4>(ciphertext_no_xor_process[k][14])[2] )) << " ";
        ...
        for( int k = 0; k < 16; k ++)
        {
            ...
            temp_1 = ciphertext_no_xor_process[k][2] ^ ciphertext_no_xor_process[k][14];
            temp_2 = ciphertext_no_xor_process[k][7];
            ...
            outfile <<  (static_cast<int>(std::bitset<4>(temp_2)[3] ) ^cp_x_0) << " ";
        ...
        for( int k = 0; k < 16; k ++)
        {
            ...
            outfile <<  (static_cast<int>(std::bitset<4>(temp_2)[3] ) ^ cp_x_0 ^ cp_x_2) << " ";
        ...
        for( int k = 0; k < 16; k ++)
        {
            ...
            outfile <<  (static_cast<int>(std::bitset<4>(temp_2)[3] ) ^ cp_x_0 ^ cp_x_3) << " ";
        ...
        for( int k = 0; k < 16; k ++)
        {
            ...
            outfile <<  (static_cast<int>(std::bitset<4>(temp_2)[3] ) ^ cp_x_0 ^ cp_x_2 ^ cp_x_3) << " ";
        ...
        for( int k = 0; k < 16; k ++)
        {
            ...
            outfile <<  (static_cast<int>(std::bitset<4>(temp_2)[2] ) ^cp_x_3 ) << " ";
        ...
        for( int k = 0; k < 16; k ++)
        {
            ...
            outfile <<  (static_cast<int>(std::bitset<4>(temp_2)[2] ) ^ cp_x_3 ^ cp_x_1 ) << " ";
        ...
        for( int k = 0; k < 16; k ++)
        {
            ...
            outfile <<  (static_cast<int>(std::bitset<4>(temp_2)[2] ) ^ cp_x_3 ^ cp_x_2 ) << " ";
        ...
        for( int k = 0; k < 16; k ++)
        {
            ...
            outfile <<  (static_cast<int>(std::bitset<4>(temp_2)[2] ) ^ cp_x_3 ^ cp_x_2^ cp_x_1) << " ";
        ...
        for( int k = 0; k < 16; k ++)
        {
            ...
            int x_3_6r_2 = static_cast<int>(std::bitset<4>(ciphertext_no_xor_process[k][2])[3] );int x_2_6r_2 = static_cast<int>(std::bitset<4>(ciphertext_no_xor_process[k][2])[2] );int x_1_6r_2 = static_cast<int>(std::bitset<4>(ciphertext_no_xor_process[k][2])[1] ); int x_0_6r_2 = static_cast<int>(std::bitset<4>(ciphertext_no_xor_process[k][2])[0] );
            int x_3_6r_7 = static_cast<int>(std::bitset<4>(ciphertext_no_xor_process[k][7])[3] );int x_2_6r_7 = static_cast<int>(std::bitset<4>(ciphertext_no_xor_process[k][7])[2] );int x_1_6r_7 = static_cast<int>(std::bitset<4>(ciphertext_no_xor_process[k][7])[1] ); int x_0_6r_7 = static_cast<int>(std::bitset<4>(ciphertext_no_xor_process[k][7])[0] );
            int x_3_6r_14 = static_cast<int>(std::bitset<4>(ciphertext_no_xor_process[k][14])[3] );int x_2_6r_14 = static_cast<int>(std::bitset<4>(ciphertext_no_xor_process[k][14])[2] );int x_1_6r_14 = static_cast<int>(std::bitset<4>(ciphertext_no_xor_process[k][14])[1] ); int x_0_6r_14 = static_cast<int>(std::bitset<4>(ciphertext_no_xor_process[k][14])[0] );
