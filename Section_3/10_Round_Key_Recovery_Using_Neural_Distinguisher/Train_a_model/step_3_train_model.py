...
def gen_train_or_val_data(train_num, load_file_name):
    ...
    train_X_label_0 = np.random.choice([0, 1], size=(train_num_label_1 * 4, 16, 12))
    ...
    train_X_column_3 = x_3_6r_7 ^cp_x_0
    train_X_column_4 = x_3_6r_7 ^ cp_x_0 ^ cp_x_2
    train_X_column_5 = x_3_6r_7 ^ cp_x_0 ^ cp_x_3
    train_X_column_6 = x_3_6r_7 ^ cp_x_0 ^ cp_x_2 ^ cp_x_3
    train_X_column_7 = x_2_6r_7 ^cp_x_3 
    train_X_column_8 = x_2_6r_7 ^ cp_x_3 ^ cp_x_1
    train_X_column_9 = x_2_6r_7 ^ cp_x_3 ^ cp_x_2
    train_X_column_10 = x_2_6r_7 ^ cp_x_3 ^ cp_x_2^ cp_x_1
    train_X_column_11 = x_3_6r_2 ^ x_2_6r_2 ^ x_3_6r_7  ^ x_2_6r_7 ^ x_3_6r_14 ^  x_2_6r_14
    train_X_column_12 = x_3_6r_2 ^ x_1_6r_2 ^ x_0_6r_2 ^ x_3_6r_7  ^ x_1_6r_7  ^ x_0_6r_7 ^ x_3_6r_14 ^  x_1_6r_14 ^ x_0_6r_14 
    ...
    train_X_label_0 = np.concatenate([train_X_column_1, train_X_column_2, train_X_column_3, train_X_column_4, train_X_column_5, 
                                      train_X_column_6, train_X_column_7, train_X_column_8, train_X_column_9, train_X_column_10, 
                                      train_X_column_11, train_X_column_12,   
...
def train_one_model(train_num,  train_func, repeat_num, file_name_1, file_name_2):
    ...
    t = int(time.time())
    check = ModelCheckpoint(wdir + f'{model_name}_train_data_{train_num_record}_best_{repeat_num}_{t}'  + '.h5', monitor='val_loss', save_best_only=True)
