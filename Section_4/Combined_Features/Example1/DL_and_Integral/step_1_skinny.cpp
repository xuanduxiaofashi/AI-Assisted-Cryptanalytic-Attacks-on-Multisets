...
int main()
{
    ...
    for (int i = 0 ; i < repeat_num; i ++)
    {
        ...
        {
            int temp = 
            static_cast<int>(std::bitset<4>(ciphertext_no_xor[k][2])[3] ) ^ static_cast<int>(std::bitset<4>(ciphertext_no_xor[k][7])[3] ) ^ static_cast<int>(std::bitset<4>(ciphertext_no_xor[k][14])[3] );
            outfile <<  temp << " ";
        ...
        {
            int temp = 
            static_cast<int>(std::bitset<4>(ciphertext_no_xor[k][2])[2] ) ^ static_cast<int>(std::bitset<4>(ciphertext_no_xor[k][7])[2] ) ^ static_cast<int>(std::bitset<4>(ciphertext_no_xor[k][14])[2] );
            outfile <<  temp << " ";
        ...
        for( int k = 0; k < 16; k ++)  // mask3
        {
            ...
            outfile << (x_1_6r_2 ^ x_1_6r_7   ^ x_1_6r_14      )  << " ";
        }
        ...
        outfile << (x_0_6r_2 ^ x_0_6r_7   ^ x_0_6r_14              )  << " ";
        ...
        for( int k = 0; k < 16; k ++)  
        {
            temp_xor_1 = temp_xor_1 ^ ciphertext_no_xor[k][6] ^ ciphertext_no_xor[k][10] ^ ciphertext_no_xor[k][14];                   
        }

        outfile << static_cast<int>(std::bitset<4>( temp_xor_1)[3] ) << " ";
        outfile << static_cast<int>(std::bitset<4>( temp_xor_1)[1] ) << " ";
        outfile <<( static_cast<int>(std::bitset<4>( temp_xor_1)[3] ) ^ static_cast<int>(std::bitset<4>(temp_xor_1)[1] ) )<< " ";

        int temp_xor_2 = 0;
        for( int k = 0; k < 16; k ++)  
        {
            temp_xor_2 = temp_xor_2 ^ ciphertext_no_xor[k][5] ^ ciphertext_no_xor[k][9] ^ ciphertext_no_xor[k][13];                   
        }
   
        outfile << static_cast<int>(std::bitset<4>( temp_xor_2)[3] ) << " ";
        outfile << static_cast<int>(std::bitset<4>( temp_xor_2)[1] ) << " ";
        outfile <<( static_cast<int>(std::bitset<4>( temp_xor_2)[3] ) ^ static_cast<int>(std::bitset<4>(temp_xor_2)[1] ) )<< " ";
        outfile << (static_cast<int>(std::bitset<4>( temp_xor_1)[3] ) ^ static_cast<int>(std::bitset<4>( temp_xor_2)[3] ) ) << " "; 
        outfile << endl;
